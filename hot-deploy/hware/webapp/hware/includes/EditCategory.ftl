...
<#if ! productCategory?has_content>
    <#if productCategoryId?has_content>
        ...
        <div class="screenlet-body">
            <form action="<@ofbizUrl>CreateAndAddProductCategory</@ofbizUrl>" method="post" style="margin: 0;" name="productCategoryForm">
    ...
    <#else>
        <div class="screenlet-title-bar">
          <ul>
            <li class="h3">${uiLabelMap.ProductProductCategory}</li>
          </ul>
          <br class="clear" />
        </div>
        <div class="screenlet-body">
