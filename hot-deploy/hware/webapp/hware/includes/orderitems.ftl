        ...
        <div class="screenlet-body">
            <table class="order-items basic-table" cellspacing='0'>
                <tr valign="bottom" class="header-row">
                    ...
                    <td width="5%"></td>
                    <td width="24%" align="right">${uiLabelMap.OrderQuantity}</td>
                    <td width="13%" align="right">${uiLabelMap.OrderUnitList}</td>
                    <td width="13%" align="right">${uiLabelMap.OrderAdjustments}</td>
                    <td width="13%" align="right">${uiLabelMap.OrderSubTotal}</td>
                    <td width="2%">&nbsp;</td>
               </tr>
                                        ...
                                        <div >
                                            <table>
                                                <tr valign="top">
                                                    ...
                                                    <td align="right">${orderItem.quantity?default(0)?string.number}</td>
                                             </table>
                                        </div>
                                    </div>
                                </td>
