    ...
    <div class="screenlet">
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            <td>
              <form method="post" name="selectProduct" width="500" action="<@ofbizUrl secure="${request.isSecure()?string}">additem</@ofbizUrl>" class="smallForm" >
                <table cellspacing="0" class = "basic-table">
                  <tbody>
                    ...
                    <tr>
                      <td>Product:</td>
                      <td>  
                        <select id = "add_product_id" name = "add_product_id" class="brand">
                        <#list brands as brand>
                    ...
                    <tr><td>Quantity :</td><td>  <input type = "text" value = "1" name = "quantity"></td></tr>
