...
<div class="screenlet">
  ...
  <div class="screenlet-body">
          ...
          <tr>
            ...
            <td valign="top" width="60%">
              <#list invoices as invoice>
                ...
                <#-- custom code for generating personalized invoice -->
                (<a href="/hware/control/invoice.pdf?invoiceId=${invoice}&amp;orderId=${orderId}&amp;externalLoginKey=${externalLoginKey}" class="buttontext">PDF</a>)</div>
              </#list>
            </td>
            <td width="10%">&nbsp;</td>
          </tr>
   ...
   <tr>
    ...
    <#if (orderHeader.statusId.equals("ORDER_APPROVED"))>
        <center>
         <a href="/hware/control/completeOrder?orderId=${orderId}" class="buttontext">Complete Order</a>
         </center>
    </#if>
</div>
</div>
