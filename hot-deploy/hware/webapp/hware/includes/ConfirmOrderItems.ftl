<div class="screenlet">
    ...
    <div class="screenlet-body">
            ...
            <tr>
              ...
              <#else>
                ...
                <td align="right" valign="top">
                  <div id="quantity" nowrap="nowrap">${orderItem.quantity?string.number}</div>
                </td>
                <td align="right" valign="top">
                  <div  id="unitPrice" nowrap="nowrap"><@ofbizCurrency amount=orderItem.unitPrice isoCode=currencyUomId/></div>
                </td>
                <td align="right" valign="top">
                  <div adjustmentsTotal nowrap="nowrap"><@ofbizCurrency amount=localOrderReadHelper.getOrderItemAdjustmentsTotal(orderItem) isoCode=currencyUomId/></div>
                </td>
                <td align="right" valign="top" nowrap="nowrap">
                  <div id="orderSubTotal"><@ofbizCurrency amount=localOrderReadHelper.getOrderItemSubTotal(orderItem) isoCode=currencyUomId/></div>
                </td>
                <#if maySelectItems?default(false)>
                  <td>
     ...
     <#-- Adding form to allow Order adjustments-->

          <form name="addAdjustmentForm" method="post" action="<@ofbizUrl>addPriceAdjustment</@ofbizUrl>">
            <input type="hidden" name="comments" value="Added manually by [${userLogin.userLoginId?if_exists}]"/>
            <input type="hidden" name="shipGroupSeqId" value="_NA_"/>
            <tr>
              <td align="right" colspan="4">
                <span class="tableheadtext">${uiLabelMap.OrderAdjustment?if_exists} :</span>
                <select name="orderAdjustmentTypeId" class="selectBox">
                  <#list orderAdjustmentTypes as type>
                    <option value="${type.orderAdjustmentTypeId}">${type.description}</option>
                  </#list>
                </select>
              </td>
              <td align="left">
                <div class="tabletext"><input type="text" name="description" value="" size="30" maxlength="60" class="inputBox">
                </div>
              </td>
              <td align="left">
