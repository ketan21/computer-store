      ...
      <#if illegalInventoryItem?exists>
        ...
        <#else>
          ...
          <table cellspacing="0" class="basic-table">
            ...
            <input type="hidden" name="statusId" value="IXF_COMPLETE"/>
            ...
            <tr>
              <td width="14%">&nbsp;</td>
              <td width="6%" align="right" nowrap="nowrap"><span class="label">QOH</span></td>
              <td width="6%">&nbsp;</td>
            ...
            <#if !(inventoryTransfer?exists)>
              <tr>
                <td width="14%">&nbsp;</td>
                <td width="6%" align="right" nowrap="nowrap"><span class="label">To Facility</span></td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
                  <div>
                    <select name="facilityIdTo">
                      <#list facilities as nextFacility>
                        <#if nextFacility.facilityId != parameters.facilityId >
